...
from stargan2_solver import Solver
...
if __name__ == '__main__':
    ...
    # Model configuration.
    parser.add_argument('--num_domains', type=int, default=5, help='dimension of domain labels (1st dataset)')
    ...
    parser.add_argument('--e_lr', type=float, default=0.0001, help='learning rate for E')
